...
{
    // All of these routes will be at the base URL:     /api/Feeding
    // That is what "api/[controller]" means below. It uses the name of the controller
    // in this case FeedingController to determine the URL
    ...
    public class FeedingController : ControllerBase
    {
        ...
        public FeedingController(DatabaseContext context)
        {
            _context = context;
        }
